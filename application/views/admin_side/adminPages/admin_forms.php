<div class="content-wrapper">
			...
			<div class="col-sm-12">
				<h2 data-toggle="collapse" data-target="#system_admin_filter" class="detail_popup">Filters</h2>
			...
			<div class="col-sm-12">
				...
				<table id="example" class="display" cellspacing="0" width="100%">
					<thead>
						<tr>
							<th>Name</th>
							<th>Talent Network</th>
							<th class="none">abc</th>
							<th>Contract Types</th>
							<th>Locations recruiting</th>
							<th>Actions</th>
						</tr>
					</thead>
					...
					<tbody>
						<tr>
							...
							<td>Northland</td>
							<td align="center">
								<button type="submit" class="button btn-sm btn-success">
									<i class="fa fa-check" aria-hidden="true"></i>
								</button>
								<button type="submit" class="button btn-sm btn-danger" data-toggle="modal" data-target="#myModal_hire_delete">
