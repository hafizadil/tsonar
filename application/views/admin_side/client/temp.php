<div class="content-wrapper">
            ...
            <div class="col-sm-12">
                <h2 data-toggle="collapse" data-target="#pools_filter" class="detail_popup">Temporary Talent</h2>
				<div class="collapse" id="pools_filter">
					<div class="filter_category" id="team_filter_bar">
						<div class="col-sm-12 price_box p0">
						   <div class="clear20"></div>
							...
							<div class="col-sm-4 form_padd_left">
								<select class="form-control">
									<option value="">Number of Jobs</option>
							...
							<div class="col-sm-4 form_padd_left">
								<select class="form-control">
									<option value="">Number of Intros</option>
							...
							<div class="col-sm-4 ">
								<select class="form-control">
									<option value="">Number of Hires</option>
									<option value="1">5</option>
									<option value="1">10</option>
									<option value="1">15</option>
									<option value="2">20</option>
							...
							<div class="col-sm-4 form_padd_left">
								<select class="form-control">
									<option value="">Earn Money</option>
