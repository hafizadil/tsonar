				...
				<ul class="sidebar-menu">
					<li class="dropdown user user-menu">
						...
						<ul class="dropdown-menu sidebar_profile">
							...
							<?php
								// echo "<pre>";print_r($this->session->userdata('role_id'));
							?>
					...
					<li class=" <?php if($page=='ReviewRequests'  ){echo 'active';}?>">
						<a href="<?php echo base_url('ReviewRequests');?>"><i class="fa fa-list"></i> <span>Review Requests</span>
							<span class="pull-right-container">
								<i class="fa fa-angle-left pull-right"></i>
							</span>
						</a>
					...
					{
					?>
					<li class="treeview <?php if($page=='clientAdminProfile'  ){echo 'active';}?>">
						<a href="<?php echo base_url('clientAdminProfile');?>"><i class="fa fa-book"></i> <span>Client Admin Profile</span>
							<span class="pull-right-container">
								<i class="fa fa-angle-left pull-right"></i>
							</span>
						</a>
					</li>
					<li class="treeview <?php if($page=='CompanyProfile'  ){echo 'active';}?>">
						<a href="<?php echo base_url('CompanyProfile');?>"><i class="fa fa-book"></i> <span>Company Profile</span>
							<span class="pull-right-container">
								<i class="fa fa-angle-left pull-right"></i>
							</span>
						</a>
					...
					<li class="treeview <?php if($page=='clientAdminUsers'  ){echo 'active';}?>">
						<a href="<?php echo base_url('clientAdminUsers');?>">
					...
					<li class="treeview <?php if($page=='clientAdminBillings'  ){echo 'active';}?>">
						<a href="<?php echo base_url('clientAdminBillings');?>">
					...
					<li class="treeview <?php if($page=='clientAdminReports'  ){echo 'active';}?>">
						<a href="<?php echo base_url('clientAdminReports');?>">
