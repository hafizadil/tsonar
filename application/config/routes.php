...
// MARKET INSIGHT ROUTES ENDS
$route['Professional'] = 'client/Professional/professional_';
$route['EmergingTalent'] = 'client/EmergingTalent/emergingtalent_';
$route['Temp'] = 'client/Temp/temp_';

//Market Insights
$route['SalaryBenchmarking'] = 'client/SalaryBenchmarking/salarybenchmarking_';
$route['TalentBenchmarking'] = 'client/TalentBenchmark/talentbenchmark_';
$route['MarketMapTalentIntros'] = 'client/MarketMapTalentIntros/marketmaptalentintros_';

//Leaver Insights
$route['LeaverSurvey'] = 'client/LeaverSurvey/leaversurvey_';
$route['LeaverInterview'] = 'client/LeaverInterview/leaverinterview_';
//client
$route['Support'] = 'client/Support/support_';
// ADMIN CLIENT ROUTES ENDS 

//client adming profile
$route['clientAdminProfile'] = 'admin/profile/client_admin_profile';
$route['CompanyProfile'] = 'admin/profile/CompanyProfile';

// CLIENT ADMIN USERS
$route['clientAdminUsers'] = 'client/ClientAdminUsers/client_users';
$route['add_HiringManager'] = 'client/ClientAdminUsers/add_Clientarea_HiringManager';
$route['get_HiringManager/(:any)'] = 'client/ClientAdminUsers/get_Clientarea_HiringManager/$1';
$route['update_HiringManager'] = 'client/ClientAdminUsers/update_Clientarea_HiringManager';
$route['delete_HiringManager'] = 'client/ClientAdminUsers/delete_Clientarea_HiringManager';

// CLIENT ADMIN BILLINGS
$route['clientAdminBillings'] = 'client/ClientAdminBillings/client_billings';


// CLIENT ADMIN REPORTS
$route['clientAdminReports'] = 'client/ClientAdminReports/client_reports';

$route['ReviewRequests'] = 'admin/ReviewRequests/reviewrequest_';