...
function clickMe(this_){
	...
	else if($(this_).parent().parent().parent().attr('id') == 'date_time_tab1')
	{
		active_tab_timea = 'date_time_tab';
	}		
	...
	else if($(this_).parent().parent().parent().attr('id') == 'date_time_pop1')
	{
		active_tab_timea = 'date_time_pop';
	}
	...
	if(random_color == 1){
		if( $(this_).attr("backround-attr") == 'green' ){
			...
			$(this_).parent().css("background-image","url("+base_url+"public/dist/img/user.png)");
			
			if($(this_).parent().parent().parent().attr('id') == active_tab_timea+'1'){
				$('#'+ active_tab_timea + '2').find('[all-click='+ul_tim+']').find('[all-li-click='+li_tim+']').css("background-image","url("+base_url+"public/dist/img/user.png)");
				$('#'+ active_tab_timea + '3').find('[all-click='+ul_tim+']').find('[all-li-click='+li_tim+']').css("background-image","url("+base_url+"public/dist/img/user.png)");
				$('#'+ active_tab_timea + '4').find('[all-click='+ul_tim+']').find('[all-li-click='+li_tim+']').css("background-image","url("+base_url+"public/dist/img/user.png)");
				$('#'+ active_tab_timea + '5').find('[all-click='+ul_tim+']').find('[all-li-click='+li_tim+']').css("background-image","url("+base_url+"public/dist/img/user.png)");
				$('#'+ active_tab_timea + '6').find('[all-click='+ul_tim+']').find('[all-li-click='+li_tim+']').css("background-image","url("+base_url+"public/dist/img/user.png)");
		...
		if($(this_).attr("backround-attr") === "white" ){
			...
			$(this_).parent().css("background-image","url(dist/img/phone.png)");					
			if($(this_).parent().parent().parent().attr('id') == active_tab_timea+'1'){
				$('#'+ active_tab_timea + '2').find('[all-click='+ul_tim+']').find('[all-li-click='+li_tim+']').css("background-image","url("+base_url+"public/"+base_url+"public/dist/img/phone.png)");
				$('#'+ active_tab_timea + '3').find('[all-click='+ul_tim+']').find('[all-li-click='+li_tim+']').css("background-image","url("+base_url+"public/dist/img/phone.png)");
				$('#'+ active_tab_timea + '4').find('[all-click='+ul_tim+']').find('[all-li-click='+li_tim+']').css("background-image","url("+base_url+"public/dist/img/phone.png)");
				$('#'+ active_tab_timea + '5').find('[all-click='+ul_tim+']').find('[all-li-click='+li_tim+']').css("background-image","url("+base_url+"public/dist/img/phone.png)");
				$('#'+ active_tab_timea + '6').find('[all-click='+ul_tim+']').find('[all-li-click='+li_tim+']').css("background-image","url("+base_url+"public/dist/img/phone.png)");
			}				
			return;
		}
		...
		if($(this_).attr("backround-attr") === "" ){
			$(this_).attr("backround-attr","green");
			$(this_).parent().css("background-image","url("+base_url+"public/dist/img/phone.png)");
			$(this_).attr("meetup-attr","phone");
			
			if($(this_).parent().parent().parent().attr('id') == active_tab_timea+'1'){
				$('#'+ active_tab_timea + '2').find('[all-click='+ul_tim+']').find('[all-li-click='+li_tim+']').css("background-image","url("+base_url+"public/dist/img/phone.png)");
				$('#'+ active_tab_timea + '3').find('[all-click='+ul_tim+']').find('[all-li-click='+li_tim+']').css("background-image","url("+base_url+"public/dist/img/phone.png)");
				$('#'+ active_tab_timea + '4').find('[all-click='+ul_tim+']').find('[all-li-click='+li_tim+']').css("background-image","url("+base_url+"public/dist/img/phone.png)");
				$('#'+ active_tab_timea + '5').find('[all-click='+ul_tim+']').find('[all-li-click='+li_tim+']').css("background-image","url("+base_url+"public/dist/img/phone.png)");
				$('#'+ active_tab_timea + '6').find('[all-click='+ul_tim+']').find('[all-li-click='+li_tim+']').css("background-image","url("+base_url+"public/dist/img/phone.png)");
	...
	if(random_color == 3){
		if( $(this_).attr("backround-attr") == 'green' ){
			...
			if($(this_).parent().parent().parent().attr('id') == active_tab_timea+'1'){
				...
				$('#'+ active_tab_timea + '4').find('[all-click='+ul_tim+']').find('[all-li-click='+li_tim+']').css("background-image","url("+base_url+"public/dist/img/user.png)");
				$('#'+ active_tab_timea + '5').find('[all-click='+ul_tim+']').find('[all-li-click='+li_tim+']').css("background-image","url("+base_url+"public/dist/img/user.png)");
				$('#'+ active_tab_timea + '6').find('[all-click='+ul_tim+']').find('[all-li-click='+li_tim+']').css("background-image","url("+base_url+"public/dist/img/users.png)");
			}
			return;
		}
		...
		if($(this_).attr("backround-attr") === "white" ){
			$(this_).attr("backround-attr","green");
			$(this_).parent().css("background-image","dist/img/phone.png");
			if($(this_).parent().parent().parent().attr('id') == active_tab_timea+'1'){
				$('#'+ active_tab_timea + '2').find('[all-click='+ul_tim+']').find('[all-li-click='+li_tim+']').css("background-image",""+base_url+"public/dist/img/phone.png");
				$('#'+ active_tab_timea + '3').find('[all-click='+ul_tim+']').find('[all-li-click='+li_tim+']').css("background-image",""+base_url+"public/dist/img/phone.png");
				$('#'+ active_tab_timea + '4').find('[all-click='+ul_tim+']').find('[all-li-click='+li_tim+']').css("background-image",""+base_url+"public/dist/img/phone.png");
				$('#'+ active_tab_timea + '5').find('[all-click='+ul_tim+']').find('[all-li-click='+li_tim+']').css("background-image",""+base_url+"public/dist/img/phone.png");
				$('#'+ active_tab_timea + '6').find('[all-click='+ul_tim+']').find('[all-li-click='+li_tim+']').css("background-image",""+base_url+"public/dist/img/phone.png");
			}								
			return;
		}
