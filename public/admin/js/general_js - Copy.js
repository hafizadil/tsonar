...
function clickMe(this_){
	...
	if(random_color == 1){
		if( $(this_).attr("backround-attr") == 'green' ){
			...
			$(this_).parent().css("background-image","url(dist/img/user.png)");
			
			if($(this_).parent().parent().parent().attr('id') == active_tab_timea+'1'){
				$('#'+ active_tab_timea + '2').find('[all-click='+ul_tim+']').find('[all-li-click='+li_tim+']').css("background-image","url(dist/img/user.png)");
				$('#'+ active_tab_timea + '3').find('[all-click='+ul_tim+']').find('[all-li-click='+li_tim+']').css("background-image","url(dist/img/user.png)");
				$('#'+ active_tab_timea + '4').find('[all-click='+ul_tim+']').find('[all-li-click='+li_tim+']').css("background-image","url(dist/img/user.png)");
				$('#'+ active_tab_timea + '5').find('[all-click='+ul_tim+']').find('[all-li-click='+li_tim+']').css("background-image","url(dist/img/user.png)");
				$('#'+ active_tab_timea + '6').find('[all-click='+ul_tim+']').find('[all-li-click='+li_tim+']').css("background-image","url(dist/img/user.png)");
			}
			return;
		}
		...
		if($(this_).attr("backround-attr") === "white" ){
			...
			if($(this_).parent().parent().parent().attr('id') == active_tab_timea+'1'){
				$('#'+ active_tab_timea + '2').find('[all-click='+ul_tim+']').find('[all-li-click='+li_tim+']').css("background-image","url(dist/img/phone.png)");
				$('#'+ active_tab_timea + '3').find('[all-click='+ul_tim+']').find('[all-li-click='+li_tim+']').css("background-image","url(dist/img/phone.png)");
				$('#'+ active_tab_timea + '4').find('[all-click='+ul_tim+']').find('[all-li-click='+li_tim+']').css("background-image","url(dist/img/phone.png)");
				$('#'+ active_tab_timea + '5').find('[all-click='+ul_tim+']').find('[all-li-click='+li_tim+']').css("background-image","url(dist/img/phone.png)");
				$('#'+ active_tab_timea + '6').find('[all-click='+ul_tim+']').find('[all-li-click='+li_tim+']').css("background-image","url(dist/img/phone.png)");
			}				
			return;
		}
	...
	if(random_color == 3){
		if( $(this_).attr("backround-attr") == 'green' ){
			...
			if($(this_).parent().parent().parent().attr('id') == active_tab_timea+'1'){
				...
				$('#'+ active_tab_timea + '4').find('[all-click='+ul_tim+']').find('[all-li-click='+li_tim+']').css("background-image","url(dist/img/user.png)");
				$('#'+ active_tab_timea + '5').find('[all-click='+ul_tim+']').find('[all-li-click='+li_tim+']').css("background-image","url(dist/img/user.png)");
				$('#'+ active_tab_timea + '6').find('[all-click='+ul_tim+']').find('[all-li-click='+li_tim+']').css("background-image","url(dist/img/users.png)");
			}
			return;
		}
		...
		if($(this_).attr("backround-attr") === "white" ){
			...
			if($(this_).parent().parent().parent().attr('id') == active_tab_timea+'1'){
				$('#'+ active_tab_timea + '2').find('[all-click='+ul_tim+']').find('[all-li-click='+li_tim+']').css("background-image","dist/img/phone.png");
				$('#'+ active_tab_timea + '3').find('[all-click='+ul_tim+']').find('[all-li-click='+li_tim+']').css("background-image","dist/img/phone.png");
				$('#'+ active_tab_timea + '4').find('[all-click='+ul_tim+']').find('[all-li-click='+li_tim+']').css("background-image","dist/img/phone.png");
				$('#'+ active_tab_timea + '5').find('[all-click='+ul_tim+']').find('[all-li-click='+li_tim+']').css("background-image","dist/img/phone.png");
				$('#'+ active_tab_timea + '6').find('[all-click='+ul_tim+']').find('[all-li-click='+li_tim+']').css("background-image","dist/img/phone.png");
			}								
			return;
		}
...
//console.log($(this_).attr("backround-attr"));
	if(random_color_scheme == 1){
		...
		if($(this_).attr("backround-attr") === "white" ){
			$(this_).attr("backround-attr","green");
			$(this_).css("background-color","green");
			return;
		}
